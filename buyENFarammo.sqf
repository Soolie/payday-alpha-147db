...
if (playerMoney >= _cost) then {
	...
	_newBox addMagazineCargoGlobal ["30Rnd_65x39_caseless_green" , 6];
	_newBox addMagazineCargoGlobal ["1Rnd_HE_Grenade_shell" , 2];
	_newBox addMagazineCargoGlobal ["UGL_FlareWhite_F" , 1];
