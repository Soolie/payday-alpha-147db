...
hint "crimenet creating AI";
	...
	_jobname = _jobtype;	
	_AlarmMarker = createMarkerLocal[_jobname,_position];
	
	_AlarmMarker setMarkerShapeLocal "ICON";
	_AlarmMarker setMarkerTypeLocal "hd_flag";
	_AlarmMarker setMarkerTextLocal _jobname;
	...
	player sideChat "House job available";
	...
	{ 
	hint "no job created to prevent double (house) spawn";
